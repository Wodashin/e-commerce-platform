...
import { Heart, MessageCircle, Truck, Shield, RotateCcw, Calendar, ArrowLeft, Check, ShoppingCart } from "lucide-react"
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 pt-4 border-t">
            ...
            <div className="flex gap-3">
              <Button size="lg" className={`flex-1 gap-2 ${added ? "bg-green-600" : ""}`} onClick={handleAddToCart} disabled={!selectedVariant || selectedVariant.stock_quantity <= 0}>
                {added ? <Check /> : <ShoppingCart />} {added ? "Agregado" : "Agregar al Carrito"}
              </Button>
