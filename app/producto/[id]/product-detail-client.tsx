...
import { toast } from "sonner" // Usamos sonner para notificaciones, asegúrate de tenerlo o usa alert()
...
export default function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  const handleAddToCart = () => {
    ...
    // Si no tienes 'sonner' instalado, puedes usar alert("Agregado al carrito")
  }
