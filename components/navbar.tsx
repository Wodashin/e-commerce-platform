...
import { Search, ShoppingCart, Heart, User, Package, Settings, LogOut, Menu, X, Plus } from "lucide-react"
            ...
            {isLoggedIn ? (
              <>
                ...
                <Button variant="outline" size="sm" asChild>
                  <Link href="/subir-producto" className="flex items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="w-56" align="end" forceMount>
                    ...
                    <DropdownMenuItem asChild>
                      <Link href="/mis-productos" className="flex items-center">
            ...
            <div className="flex flex-col space-y-2">
              ...
              {isLoggedIn ? (
                <>
                  ...
                  <Button variant="ghost" className="justify-start" asChild>
                    <Link href="/subir-producto" className="flex items-center">
                  ...
                  <Button variant="ghost" className="justify-start text-red-600" onClick={() => setIsLoggedIn(false)}>
